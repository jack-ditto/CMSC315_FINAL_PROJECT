...
public class KruskalsAlgorithm extends JPanel {
  ...
  public KruskalsAlgorithm(LinkedList<Vertex> vertices, LinkedList<Edge> edges) {
    // super();
    // parent = _parent;
  ...
  public Tree run() {
    return Kruskal(this.vertices, this.pq);
  }

  /**
   * Kruskal's Algorithm - computes the minimum spanning tree of a graph
   *
   * Input: A set of vertices, a set of edges Output: A minimum spannining tree
   */
